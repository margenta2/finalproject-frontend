...
const Glossary = () => {
    return (
        <div>
            ...
            <h1>Glossary</h1>
            <p>This glossary lists commonly used terms in the Jehovah's Witness (JW) and ex-Jehovah's Witness (ex-JW) community. The definitions reflect the meaning within this community. </p>
            <ul>
