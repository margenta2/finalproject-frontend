...
const DeProgram = () => {
    return (
        <div>
            ...
            <p>These resources can help you start to reclaim your mind and confirm why leaving the Jehovah's Witnesses is the right decision. </p>

            <ul><h3>YouTube Channels</h3>
                <li>Lloyd Evans</li>
                <li>Telltale</li>
